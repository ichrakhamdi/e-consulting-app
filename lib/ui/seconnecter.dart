  ...
  Widget button() {
    return RaisedButton(
      ...
      onPressed: () {
        ...
        Scaffold.of(context).showSnackBar(SnackBar(content: Text('Connextion réussie')));
      },
      ...
      child: Container(
        ...
        child: Text('Se connecter', style: TextStyle(fontSize: _large ? 14 : (_medium ? 12 : 10))),
      ),
    );
  }
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Text(
              "S'inscrire",
              style: TextStyle(fontWeight: FontWeight.w800, color: Colors.green, fontSize: _large ? 19 : (_medium ? 17 : 15)),
            ),
          )
        ],
      ),
